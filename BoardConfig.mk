...
# Assert
TARGET_OTA_ASSERT_DEVICE := Infinix-X657

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := CY-X657-H8030-A

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 16793900 # This is the maximum known partition size, but it can be higher, so we just omit it
